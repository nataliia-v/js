...
class Hamburger {
  ...
  removeTopping(topping) {
    if(this._toppings.includes(topping)){
      const toppingIndex = this._toppings.indexOf(topping);
      this._toppings.splice(toppingIndex, 1);
    }
  }
  ...
  get price() {
    ...
    const toppingPrice = this.toppings.reduce((acc, current) => {
  ...
  get calories() {
    ...
    const toppingCalories = this.toppings.reduce((acc, current) => {
